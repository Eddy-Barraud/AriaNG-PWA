...
{
    public sealed partial class Download_ServicePage : Page
    {
        private Download_ServiceViewModel ViewModel => DataContext as Download_ServiceViewModel;

        public Download_ServicePage()
        {
            InitializeComponent();
